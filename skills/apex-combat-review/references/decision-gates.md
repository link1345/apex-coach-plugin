...
Record the action phase as `targeting`, `committed`, `transit`, `landing`, or `neutral`. Record move, aim, fire, weapon swap, and cancel as available, limited, unavailable, or unknown.
